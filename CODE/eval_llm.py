...
def get_llm_score(pred, ref):
    prompt = f"""Given the following two perceptual sentiment causes, score how semantically consistent, logically coherent, and sentiment aligned the prediction is compared to the gold. 
...
# === 使用 ===
avg_llm_score = compute_avg_llm_score("/data2/liuxj/1-Sentiment-mllm/model_train/result/gold/surface.txt", "/data2/liuxj/1-Sentiment-mllm/model_train/baselines/intern_result/task2.txt")
