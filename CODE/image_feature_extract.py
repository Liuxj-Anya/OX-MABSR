...
folder_path = '/data/liuxj/aspect_sentiment_detect/Twitter_data/twitter2015_images'
...
output_path=os.path.join('/data2/liuxj/1-Sentiment-mllm/model_train/data/twitter_image',"1124396"+'.npy')
image_path='/data/liuxj/aspect_sentiment_detect/Twitter_data/twitter2015_images/'+"1124396.jpg"
...
#     if file_type == None:
#         continue
#     output_path=os.path.join('/data2/liuxj/1-Sentiment-mllm/model_train/data/twitter_image',name+'.npy')
#     extract(image_path,output_path)
