...
# === 使用 ===
avg_llm_score = compute_avg_llm_score("/data2/liuxj/1-Sentiment-mllm/model_train/result/gold/think.txt", "/data2/liuxj/1-Sentiment-mllm/model_train/baselines/intern_result/task4.txt")
